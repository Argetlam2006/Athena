...
from shared.schemas import PlayerProfile, TeamProfile, RecruitmentCriteria, RecruitmentCandidate, ComparisonResult
...
from backend.recommendation.matching import evaluate_tactical_fit, get_tactical_fit_explanation
...
class DecisionIntelligenceEngine:
    ...
    def rank_candidates(self, pool: Sequence[PlayerProfile], criteria: RecruitmentCriteria) -> list[RecruitmentCandidate]:
        """
    ...
    def evaluate_team_fit(self, player: PlayerProfile, team: TeamProfile) -> dict[str, str | float]:
        """
