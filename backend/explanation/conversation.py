...
class ConversationManager:
    ...
    def add_user_message(self, content: str, context_type: str | None = None) -> None:
        self.state.messages.append(ConversationMessage(role="user", content=content, context_type=context_type))
        
    def add_assistant_message(self, content: str) -> None:
        self.state.messages.append(ConversationMessage(role="assistant", content=content))
        
    def detect_and_handle_context_change(self, current_player_id: int | None, current_team_id: int | None, current_workspace: str | None) -> bool:
        """
        ...
        if changed and self.state.messages:
            ...
            self.state.messages.append(ConversationMessage(role="system", content=transition))
