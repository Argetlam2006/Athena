...
def test_engine_process_cohort():
    ...
    p1 = PlayerFeatureVector(
        player_id=1, player_name="Lionel Messi", season="2022/2023", competition="Ligue 1",
        position_group="Forward", minutes_played=2500, matches_played=30,
        npxg_p90=0.8, progressive_passes_p90=8.0
    )
    p2 = PlayerFeatureVector(
        player_id=2, player_name="Kylian Mbappe", season="2022/2023", competition="Ligue 1",
        position_group="Forward", minutes_played=2800, matches_played=32,
        npxg_p90=0.9, progressive_passes_p90=4.0
    )
    p3 = PlayerFeatureVector(
        player_id=3, player_name="Kevin De Bruyne", season="2022/2023", competition="Premier League",
        position_group="Midfielder", minutes_played=2700, matches_played=31,
        npxg_p90=0.3, progressive_passes_p90=9.5
    )
    ...
    team_profile = engine.process_team(
        team_id=101, team_name="PSG", competition="Ligue 1", season="2022/2023",
