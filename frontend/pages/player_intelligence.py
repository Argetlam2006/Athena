...
from frontend.layout import render_divider, render_page_header, render_section_header
...
def render() -> None:
    ...
    if not state.selected_player_id:
        render_empty_state(
            "◈",
            "No Player Selected",
            "Please select a focus player from the global context menu in the sidebar to view their intelligence profile.",
        )
        return
