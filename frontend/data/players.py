...
from shared.schemas import CapabilityProfile, CapabilityScore, PlayerProfile
...
def _get_mock_profiles() -> list[PlayerProfile]:
    ...
    p1 = PlayerProfile(
        ...
        archetype_description="Elite creator and goal threat.",
    )
    ...
    p2 = PlayerProfile(
        ...
        decision_signals=["elite_goal_scorer", "clinical_finisher"],
        archetype="Advanced Forward",
        archetype_description="Pace and elite attacking threat.",
    )
    ...
    p3 = PlayerProfile(
        ...
        decision_signals=["elite_goal_scorer", "clinical_finisher"],
        archetype="Poacher",
        archetype_description="In-box goalscoring machine.",
    )
    ...
    p4 = PlayerProfile(
        ...
        age_years=26,
        minutes_played=2800,
        capability_profile=cap4,
        decision_signals=["elite_ball_progressor", "defensive_specialist"],
        archetype="Deep-Lying Playmaker",
        archetype_description="Midfield controller and progressor.",
    )
