...
def build_context_for_prompt(query: str, active_workspace_id: str, selected_player_id: int | None, selected_team_id: int | None):
    ...
    classification = IntentClassifier.classify(query, active_workspace_id, player_id_list)

    if classification.intent == ConversationIntent.PLAYER_ANALYSIS and selected_player_id:
...
def process_athena_turn(query: str, active_workspace_id: str, selected_player_id: int | None, selected_team_id: int | None):
