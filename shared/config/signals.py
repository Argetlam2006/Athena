...
SIGNAL_DEFINITIONS: dict[str, dict[str, str]] = {
    ...
    "strong_chance_creator": {
        "label": "Strong Chance Creator",
        "category": "Attacking",
    },
    "clinical_finisher": {"label": "Clinical Finisher", "category": "Attacking"},
    "xg_efficient_attacker": {
        "label": "xG-Efficient Attacker",
        "category": "Attacking",
    },
    "dual_threat_forward": {"label": "Dual Threat Forward", "category": "Attacking"},
    # Progression
    "elite_ball_progressor": {
        "label": "Elite Ball Progressor",
    ...
    "line_breaking_passer": {
        "label": "Line-Breaking Passer",
        "category": "Progression",
    },
    "ball_carrying_threat": {
        "label": "Ball-Carrying Threat",
        "category": "Progression",
    },
    # Technical
    "high_press_resistant": {"label": "High Press Resistant", "category": "Technical"},
    "technical_ball_retainer": {
        "label": "Technical Ball Retainer",
        "category": "Technical",
    },
    ...
    "high_intensity_presser": {
        "label": "High-Intensity Presser",
        "category": "Defensive",
    },
